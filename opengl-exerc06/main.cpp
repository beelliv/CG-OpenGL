...
int main(void)
{
	...
	//--------JANELA--------
	window = createWindow(1024, 768, "Exercício 6"); //inicializa as bibliotecas GLEW e GLFW e cria a janela
	...
	vertexPos.push_back(Vector3f(1.0f, -1.0f, 0.0f));
	vertexColor.push_back(RandColor());
	vertexColor.push_back(RandColor());
	vertexColor.push_back(RandColor());

	Object triangle1;
	triangle1.create(vertexPos, vertexColor); //cria o objeto com base na opsição dos vértices
	...
	Object triangle2;
	triangle2.create(vertexPos, vertexColor);
